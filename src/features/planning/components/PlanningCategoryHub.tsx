...
import classes from './PlanningCategoryHub.module.css';

interface PlanningCategoryHubProps {
  item: GroupItem;
...
export default function PlanningCategoryHub({
  item,
  transactions,
  busy,
  onTrack,
    ...
    <div className={classes.hub}>
      ...
      <div className={classes.txList}>
        {transactions.length === 0 ? (
          <div className={listClasses.empty}>No transactions in this category</div>
        ) : (
